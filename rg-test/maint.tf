terraform {
  ...
  backend "azurerm" {
    ...
    key                  = "backend.terraform.tfstate.jdk"
  }
}
...
resource "azurerm_resource_group" "rg_backend_name" {
...
resource "azurerm_storage_account" "sa_backend" {
  ...
  resource_group_name      = azurerm_resource_group.rg_backend_name.name
  location                 = azurerm_resource_group.rg_backend_name.location
